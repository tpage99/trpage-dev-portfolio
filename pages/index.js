    ...
    <Layout home>
      ...
      <section className="prose prose-xl md:prose-2xl border-b border-gray-300 mb-4 pb-4">
        <img
            ...
            className="inline h-36 md:h-64 w-auto rounded mb-0 pb-0 px-4"
